            ...
            <div className="2xl:container 2xl:mx-auto lg:px-20 md:py-0 p-5  mb-0 w-full h-full flex flex-col border overflow-y-scroll">
                ...
                <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                    <div className="w-full lg:w-6/12">
                        <h2 className="w-full font-bold lg:text-3xl text-2xl lg:leading-10 leading-9">We are here to Provide you 500+ Softwaere in One website & also Provide DOCs & Refernce best videos</h2>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Welcome to our platform, where we offer over 500 software solutions all in one place. Whether you need productivity tools, creative software, or specialized applications, we've curated a comprehensive collection to cater to your every need. Alongside our extensive software library, we provide detailed documentation and curated video references, ensuring you have all the resources necessary to maximize your software experience conveniently on our website.</p>
                    </div>
                    <div className="w-full lg:w-6/12">
                ...
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4 shadow-sm ">
                    <div>
                        ...
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Founded in 2024</p>
                    </div>
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Why ?</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6 overflow-y-hidden ">The purpose of opening this website is to simplify the process of finding and downloading software. Often, when we need a specific software solution, it can be challenging to locate or download it efficiently. Our platform aims to streamline this experience by allowing users to easily search for software by name and download it directly, ensuring quick access to the tools they need without unnecessary hassle.</p>
                    </div>
                    <div className="sm:block hidden">
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Who Can use</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Students, coders, programmers, teachers this is a Educational website.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center mt-10">
                    <h2 className="font-bold text-center lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mb-10">
                        About Me
                    </h2>
                    <div className="flex flex-col lg:flex-row items-center justify-center lg:gap-14 gap-16 lg:mt-20">
                        <div className="lg:w-1/2 flex flex-col items-center lg:items-start">
                            <p className="font-normal text-base leading-6 text-gray-600 lg:w-10/12 xl:w-9/12 mb-6">
                                Hello! I'm Shivam Kumar, an entry-level web developer with a B.Tech in Computer Science and Engineering. I have 1 year of experience in JavaScript,
                                React, MongoDB, CSS (including Tailwind), HTML5, Java, Node.js, and Firebase Console. I am passionate about Full Stack Development and have
                                completed several projects, including Native Android Development.
                                I excel in team coordination and leadership, and I have a proven ability to create reusable components for enterprise-level web applications. I am
                                dedicated to technology and building scalable web solutions. Let's build something great together!
                            </p>
                        </div>
                        <div className="lg:w-1/3 flex flex-col items-center">
                            <div className="flex flex-col items-center">
                                ...
                                />
                              <Link to='/contact_me'> <button className="px-4 py-2 bg-blue-500 text-white rounded-md shadow-md">
                                    Contact Me
                                </button>
                                </Link> 
                            </div>
